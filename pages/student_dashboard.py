    ...
    margin-top: 10%;
        ...
        with col1:
            with stylable_container(
                ...
                locked_lessons = utils.get_locked_lessons()
                for lesson in lessons:
                    ...
                    # check if lesson_id is in locked_lessons
                    elif lesson['_id'] in locked_lessons:
                        st.write('<img src="https://img.icons8.com/ios-filled/50/808080/lock.png" class="stImage"></div>', unsafe_allow_html=True)
                    else:
                        st.write('<img src="data:image/png;base64," class="stImage"></div>', unsafe_allow_html=True)
                    if lesson['experiments']:
                        if lesson['completed']:
                            st.write('<img src="https://upload.wikimedia.org/wikipedia/commons/5/59/Empty.png" class="stImage"></div>', unsafe_allow_html=True)
                        else:
                            st.write('<img src="https://img.icons8.com/ios-filled/50/808080/lock.png" class="stImage"></div>', unsafe_allow_html=True)
                ...
                for lesson in lessons:
                    ...
                    if lesson['experiments']:
                        if not lesson["completed"]:
                            st.markdown(f"""<div class="lesson locked">{"EXPERIMENT: " + lesson["title"]}</div>""", unsafe_allow_html=True)
                        elif st.button("EXPERIMENT: " + lesson["title"], use_container_width=True, key=f"experiment_{lesson['experiments']}_{lesson['_id']}"):
